...
public class PhysicalDetilPaymentInfo {
    private String id;
    ...
    public void setBillPaymentCode(String billPaymentCode) {
        this.billPaymentCode = billPaymentCode == null ? null : billPaymentCode.trim();
    }
